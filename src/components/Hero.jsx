      ...
      flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm <span className='text-[#915eff]'> Akshay </span></h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I develop 3D visuals using React Three Fiber, <br className='sm:block hidden' /> user interfaces and Web Applications.
          </p>
        </div>
      </div>
      <ComputersCanvas />
